...
#class ConeWallThreePiece(AutoBase):
    """
        ...
        #return SeriesAction([
           ...
           # ParallelAction([    
               ...
               # MoveArmAction(Arm_Goal.GROUND_CUBE, Arm_Goal.SIDE_FRONT),
                #SeriesAction([
                    #WaitUntilPercentCompletedTrajectoryAction(0, 0.85), 
           ...
           # ParallelAction([
               ...
               # self.trajectory_iterator.get_next_trajectory_action(),
                #SeriesAction([
                    ...
                    #MoveArmAction(Arm_Goal.HIGH_CUBE, Arm_Goal.SIDE_BACK, Arm_Goal.WRIST_180),
            ...
            #ParallelAction([
                #self.trajectory_iterator.get_next_trajectory_action(),
                #SeriesAction([
                    #WaitUntilPercentCompletedTrajectoryAction(2, 0.6),
            ...
            #ParallelAction([
                #self.trajectory_iterator.get_next_trajectory_action(),
                #SeriesAction([
                    #WaitUntilPercentCompletedTrajectoryAction(3, 0.65),
